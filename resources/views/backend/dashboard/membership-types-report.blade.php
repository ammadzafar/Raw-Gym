            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Membership Types Report Chart</h4>
                                <div id="membership-types-chart" class="apex-charts">
...
@include('backend.dashboard.ajax.membership-types-report')
