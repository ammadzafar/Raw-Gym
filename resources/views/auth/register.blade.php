                    ...
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="text-white-50 mb-0">Get your free RAW  Gym account now</p>
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="p-2">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-dark btn-block waves-effect waves-light" id="register" type="submit"> {{ __('Register') }}</button>
                                    </div>
